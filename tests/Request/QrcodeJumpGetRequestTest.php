 ...
 * @internal
 */
#[CoversClass(QrcodeJumpGetRequest::class)]
final class QrcodeJumpGetRequestTest extends RequestTestCase
{
    ...
    public function testQrcodeJumpGetRequestWithInvalidType(): void
    {
        ...
        $this->expectException(QrcodeJumpRequestException::class);
